package com.ashwin.dropwizard.service;
...
public class MongodbService {
    ...
    public void updateOneEmployee(MongoCollection<Document> collection, String key1, String key2, String key3, Employee employee) {
        collection.updateOne(new Document(key1, employee.getName()), new Document("$set", new Document(key2, employee.getDepartment()).append(key3, employee.getSalary())));
    }
